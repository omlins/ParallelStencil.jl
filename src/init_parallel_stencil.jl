...
@doc replace(ParallelKernel.ALLOC_DOC,              "@init_parallel_kernel" => "@init_parallel_stencil") macro alloc(args...)              check_initialized(); esc(:(ParallelStencil.ParallelKernel.@alloc($(args...)))); end
