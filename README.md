<h1> <img src="https://github.com/omlins/ParallelStencil.jl/blob/logo/docs/logo/logo_ParallelStencil.png" alt="ParallelStencil.jl" width="140"> ParallelStencil.jl </h1>
