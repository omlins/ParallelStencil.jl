...
annotate!(0.5, TpeakA100*1.04, text( L"T_\mathrm{peak}= " * string(TpeakA100) * " [GB/s]", :green, :left, 6))
annotate!(3.5, TpeakP100*1.08, text( L"T_\mathrm{peak}= " * string(TpeakP100) * " [GB/s]", :green, :right, 6))
